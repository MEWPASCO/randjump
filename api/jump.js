...
function blockedSite(url){
  ...
  }catch{ return true; } // keep same behavior as your raccoon route
}
...
export default async function handler(req,res){
  ...
  // minimal prefilter: same as raccoon
  ...
  // try up to 10 candidates, accept any image/*
